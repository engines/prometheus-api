  ...
  module API
    module Types
      ...
      class RangeQuery < Dry::Struct
        ...
        attribute   :start,   T::String.constrained(:format => Prometheus::API::Types::RFC3339_REGEX)
        attribute   :end,     T::String.constrained(:format => Prometheus::API::Types::RFC3339_REGEX)
        attribute   :step,    T::Integer.optional
      end

      class SnapshotQuery < Dry::Struct
        attribute   :query,   T::String
        attribute   :time,    T::String.constrained(:format => Prometheus::API::Types::RFC3339_REGEX).optional
      end
